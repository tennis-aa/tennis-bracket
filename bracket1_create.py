...
atplink = "https://www.atptour.com/en/scores/current/us-open/560/draws" # link to ATP website to scrape players
...
sets = 5 # 3 for best of three sets matches and 5 for best of five sets matches
