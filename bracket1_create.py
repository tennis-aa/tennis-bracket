...
atplink = "https://www.atptour.com/en/scores/current/wimbledon/540/draws" # link to ATP website to scrape players
...
surface = "grass" # all, hard, clay, or grass. This is used to obtain the Elo rating of the players. "all" is the default for overall Elo rating
