...
atplink = "https://www.atptour.com/en/scores/archive/roland-garros/520/2021/draws" # link to ATP website to scrape players
bracketSize = 128 # Number of players 128, 64, 32 (if there are byes in the tournament inlude them in the bracketSize, i.e., do not enter 48 or 24)
path = None # By default the files will be saved to /docs, but you can choose another path
surface = "all" # all, hard, clay, or grass. This is used to obtain the Elo rating of the players. "all" is the default for overall Elo rating
